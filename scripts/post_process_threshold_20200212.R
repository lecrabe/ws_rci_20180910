res_dir <- "/home/dannunzio/ws_rci_20180910/data/bfast_civ/"
setwd(res_dir)
...
system(sprintf("gdalbuildvrt %s %s",
               paste0(res_dir,"results_tmp.vrt"),
...
system(sprintf("gdal_translate -co COMPRESS=LZW %s %s",
               paste0(res_dir,"results_tmp.vrt"),
               paste0(res_dir,"results_tmp.tif")
))

####################  EXTRACT MAGNITUDE
# system(sprintf("gdal_translate -b 2 %s %s",
#                paste0(res_dir,"results_maindombe.tif"),
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(res_dir,"tmp_results_magnitude_pct.tif"),
               paste0(res_dir,"results_tmp_threshold.tif")
))
...
system(sprintf("gdal_translate -ot Byte -co COMPRESS=LZW %s %s",
               paste0(res_dir,"tmp_map_bfast_pct.tif"),
               paste0(res_dir,"results_civ.tif")
))
